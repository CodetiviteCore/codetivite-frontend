...
const ButtonStyle = styled.button`
  padding: 1rem 2rem;
  background-color: ${({ primary, scrolled, newsLetter, transparent }) =>
    primary
      ? "var(--primary)"
      : scrolled
      ? "var(--primary)"
      ...
      ? "transparent"
      : "var(--primary-light)"};
  color: ${({ primary, scrolled, newsLetter }) =>
    primary
      ? "var(--white)"
      : scrolled
      ? "var(--white)"
  ...
  outline: none;
  border: none;
  border-radius: ${({ preference, newsLetter, contact }) =>
    preference ? "0px" : newsLetter ? "8px" : contact ? "10px" : "6.25rem"};
